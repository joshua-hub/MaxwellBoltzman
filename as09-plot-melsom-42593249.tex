...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(1201,2541){\rotatebox{-270}{\makebox(0,0){\strut{}$\bar{g}(t)$}}}%
      \put(3940,154){\makebox(0,0){\strut{}$t$}}%
      \put(3940,4709){\makebox(0,0){\strut{}phys3071 as09 melsom 42593249}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(4791,4206){\makebox(0,0)[r]{\strut{}$\displaystyle{ \frac{ (1-t)^2 e^{-( \frac{1}{t} - 1)^2} }{t^4}}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{as09-plot-melsom-42593249}}%
    \gplfronttext
  \end{picture}%
\endgroup
